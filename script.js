...
btSearch.addEventListener('click', ()=>{
    alterarBotoes("busca")
    buscar.classList.remove("elemento")
    
})

btList.addEventListener('click', ()=>{
    alterarBotoes("lista")
    listar.classList.remove("elemento")
    // lista
...
btAdd.addEventListener('click', ()=>{
    alterarBotoes("adiciona")
    adicionar.classList.remove("elemento")
})

btUpdate.addEventListener('click', ()=>{
    alterarBotoes("atualiza")
    atualizar.classList.remove("elemento")
})

btDel.addEventListener('click', ()=>{
    alterarBotoes("deleta")
    deletar.classList.remove("elemento")
})
